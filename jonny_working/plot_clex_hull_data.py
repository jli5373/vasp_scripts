...
fit_name = 'fit.4'                          #optional parameter
...
plt.legend(['DFT energies', 'Clex energies', 'DFT Hull', 'Clex Hull', 'Clex Prediction of DFT Hull', 'Clex Below Clex Prediction of DFT Hull Configs'], fontsize=8)
plt.show()